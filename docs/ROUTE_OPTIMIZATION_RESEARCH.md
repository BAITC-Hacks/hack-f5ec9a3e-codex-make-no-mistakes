...
For this Python project, my proposed first experiment is OR-Tools with a saved road matrix from OSRM. This is a design recommendation, not a benchmark conclusion. Keep the experiment separate from production ingestion and the core replenishment deliverable.
